...
router.get('/education', function (req, res) {
  ...
  res.render('education', {
    ...
    main: {
      educations: [
        {
          name: 'Meridian International School, Kyiv',
          isEnd: true,
        },
        {
        ...
        {
          name: 'French Lycee Anne of Kyiv',
          isEnd: false,
        },
        {
          name: 'British International School, Ukraine',
          isEnd: true,
        },
        {
          ...
          projects: [
            {
              ...
              awards: [
                {
                  name: 'Building an immersive creative website from scratch without frameworks',
                },
                {
                  name: 'Create Award Winning Animation and Interaction Design In Webflow',
                },
              ],
              stackAmount: 3,
              awardAmount: 2,
...
>>>>>>> 34ce7a8ac9e66141b166935c8ec526ddee59dc2f
// ================================================================
